...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if ("yell".equalsIgnoreCase(response)) {
			...
			if ("kick".equalsIgnoreCase(response)) {
			...
			JOptionPane.showMessageDialog(null, "Player has " + playerHealth + " and the Dragon has " + dragonHealth + " health left.");
	...
	static void dragonLost() {
		...
		JOptionPane.showMessageDialog(null, "The dragon has been defeated and you've recieved a ton of gold!");
